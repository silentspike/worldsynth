...
pub const dsp = struct {
    ...
    pub const chaos = @import("dsp/chaos.zig");
    pub const layer = @import("dsp/layer.zig");
    ...
    pub const effects = struct {
        ...
        pub const fx_chain = @import("dsp/effects/fx_chain.zig");
    };
...
pub const io = struct {
    ...
    pub const cuda = @import("io/cuda.zig");
    pub const tensorrt = @import("io/tensorrt.zig");
